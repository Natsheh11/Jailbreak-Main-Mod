...
public OnFireBullets(this, iAttacker, fStart, fDirection, fVecSpread, fDist, penetration, iBulletType, iDamage, flRangeModifier, bPistol, shared_rand)
{
	cprint_chat(0, _, "Gun fired!");
}
...
FireBullets(const this, Float:fStart[3], Float:fDirection[3], Float:fVecSpread, Float:fDist, any:iBulletType, iDamage, iAttacker)
{
	...
	static RageFunc:handleFunc = RageFuncInvalid; handleFunc = !handleFunc ? RageTryGetFunction( "CBaseEntity::FireBullets3" ) : handleFunc;
	//RageCall(handleFunc, this, iAttacker, fStart, fDirection, fVecSpread, fDist, 3, iBulletType, iDamage, 0.90, false, false);
	cprint_chat(0, _, "Fire!");
}
